...
# get_order_frequency_per_costumer é uma função que retorna a frequência que uma determinada pessoa cliente pede um determinado prato , considerando que os pedidos estão em uma lista.

import pytest

# uma fixture utilizando a biblioteca pytest é definida utilizando a sintaxe abaixo
@pytest.fixture
def orders():
