...
class Orcamento:
    ...
    def calculate(self, imposto):
        return imposto.calculate_tax(self.valor)


orcamento = Orcamento(1000)
print(f"ISS: {orcamento.calculate(ISS)}")
print(f"ICMS: {orcamento.calculate(COFINS)}")
